// The site's frontend stylesheet, taken from the reference site.
//
// PORTING.md: the reference site is a FINISHED site with a fully styled theme —
// settings and CSS included. This TAKES that CSS. It does not derive it, generate it,
...
export function build() {
  ...
  const css = [
    '/* Frontend stylesheet.',
    '   TAKEN from the reference site — its own theme files,',
