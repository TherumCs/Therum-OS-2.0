...
// :10025 reference, at desktop / tablet / mobile.
//
...
// Every page that exists on both sides. Careers is deliberately absent: it has
// no counterpart on the reference (/contacts/ is a second Contacts page, not
// Careers), and auditing it against an unrelated page would invent findings.
const PAGES = [
  ['/', '/'],
