...
const EnvSchema = z.object({
  ...
  // Counter ⇄ payment-engine bridge (see src/counter/woopayBridge.ts).
  // URL is the engine's REST base (…/api); AUTH is "user:application-password".
  WOOPAY_BRIDGE_URL: z.string().url().optional(),
  WOOPAY_BRIDGE_AUTH: z.string().min(8).optional(),
