...
export const nexusCatalog: CatalogProvider[] = [
  ...
  { id: 'printify', name: 'Printify', category: 'fulfillment', authType: 'apikey', issuedBy: 'provider', join: '|', credentialHint: 'Personal Access Token (expires after 1 year)', fields: [{ label: 'Personal Access Token', secret: true }, { label: 'Shop ID', optional: true , pattern: '^[0-9]+$', example: '12345678' }] },
