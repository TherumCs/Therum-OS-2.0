...
export const nexusCatalog: CatalogProvider[] = [
  ...
  { id: 'podpartner', name: 'PodPartner', category: 'fulfillment', authType: 'apikey', join: '|', issuedBy: 'provider', credentialHint: 'Copy these three values out of PodPartner and paste them here.', fields: [{ label: 'Website' }, { label: 'Consumer key', secret: true }, { label: 'Consumer secret', secret: true }] },
  { id: 'tapstitch', name: 'Tapstitch', category: 'fulfillment', authType: 'apikey', join: '|', issuedBy: 'provider', credentialHint: 'Copy these three values out of Tapstitch and paste them here.', fields: [{ label: 'Website' }, { label: 'Consumer key', secret: true }, { label: 'Consumer secret', secret: true }] },
  { id: 'contrado', name: 'Contrado', category: 'fulfillment', authType: 'apikey', join: '|', issuedBy: 'provider', credentialHint: 'Copy these three values out of Contrado and paste them here.', fields: [{ label: 'Website' }, { label: 'Consumer key', secret: true }, { label: 'Consumer secret', secret: true }] },
