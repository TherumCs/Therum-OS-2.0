...
export const nexusCatalog: CatalogProvider[] = [
  ...
  { id: 'podplus', name: 'Podplus', category: 'fulfillment', authType: 'apikey', join: '|', issuedBy: 'your-store', connectsVia: 'store-pull-woo', credentialHint: 'Copy these three values out of Podplus and paste them here.', fields: [{ label: 'Website' }, { label: 'Consumer key', secret: true }, { label: 'Consumer secret', secret: true }] },
  ...
  { id: 'contrado', name: 'Contrado', category: 'fulfillment', authType: 'apikey', join: '|', issuedBy: 'your-store', connectsVia: 'store-pull-woo', credentialHint: 'Copy these three values out of Contrado and paste them here.', fields: [{ label: 'Website' }, { label: 'Consumer key', secret: true }, { label: 'Consumer secret', secret: true }] },
