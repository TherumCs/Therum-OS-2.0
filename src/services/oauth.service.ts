...
// connection.service is imported LAZILY (at the one call site below), not
// statically here. connection.service imports THIS module back — a static
// import both ways is a hard cycle whose load order is undefined, the exact
// hazard documented at connection.service.ts:552. Deferring this side to a
// dynamic import at call time breaks the cycle: whichever module loads first,
// the other is fully initialised by the time this line runs.
