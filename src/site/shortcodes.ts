...
/** Does this HTML need the subscribe handler shipped with it? */
export function needsSubscribeScript(html: string): boolean {
  return html.includes('data-tsc-subscribe');
}
