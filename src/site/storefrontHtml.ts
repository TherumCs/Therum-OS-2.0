...
.pdp-box__v{display:flex;align-items:center;gap:9px;margin-top:6px;font-size:15px;font-weight:600;color:var(--tx2,#888)}
...
.pdp-box--qty{align-items:flex-start;gap:6px}
