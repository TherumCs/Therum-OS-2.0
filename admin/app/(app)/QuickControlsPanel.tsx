              ...
              {tab === 'quick' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--th-space-28)' }}>
                  <Group title="Appearance">
                    ...
                    <Field label="Sidebar highlight" help="How the active item is marked — a full band, a side indicator line with highlighted text, or an underline.">
                      <SelectField domain="appearance" field="sidebarHighlight" initial={appearance.sidebarHighlight} options={[['band', 'Band'], ['indicator', 'Indicator line'], ['underline', 'Underline']]} />
                    </Field>
