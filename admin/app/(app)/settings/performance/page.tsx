    ...
    <div>
      ...
      <div className="settings-group">
        ...
        <p className="settings-group-desc">
          ...
          already set a strategy. <strong>Object cache is live too</strong> — it gates the Redis object cache for settings
          and catalog reads; turning it off sends every one of those reads back to Postgres, so leave it on unless you are
          debugging stale data. Defer-JS has nothing to defer: the public site ships one script (the admin dock), and only
          to signed-in admins.
        </p>
