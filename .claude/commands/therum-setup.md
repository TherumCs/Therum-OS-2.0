...
point at docs/PREVIEW-GAP-REPORT.md, docs/FUTURE-BUILDOUT.md,
docs/superpowers/specs/ (all design docs), and CHANGELOG.md's 2.0.0-beta.1
banner.
...
3. Remind the operator: run `/memory` to confirm CLAUDE.md loads, and copy
   `.claude/` into any new project folder (e.g. a new site build) to carry
   the kit.
